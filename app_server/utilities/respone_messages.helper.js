...
function f_get_server_validation_messages() {
  ...
  const Message_NotFoundRoute = (p_originalUrl) =>
    `Route Not Found: '${p_originalUrl}' Type the correct route path.`;
  ...
  const Message_AccountDeactivatedSubject = "Account Deactivated - Ketabi app";
  ...
  const Message_AccountDeactivatedMain =
    "You have successfully deactivated your account. We are sorry to see you go. If you have any feedback, please let us know. We would love to hear from you.";
  ...
  const Message_AccountDeactivatedNote = (p_deactivatedAt) =>
    `Your account was deactivated on ${p_deactivatedAt}.`;
  ...
  return {
    ...
    /**
     * ```
     * "Account Deactivated - Ketabi app"
     * ```
     */
    ...
    /**
     * ```
     * `Your account was deactivated on ${deactivatedAt}.`
     * ```
     */
